...
class StoreMahasiswaRequest extends FormRequest
{
    ...
    {
        return [
            'txtid' => 'required|unique:mahasiswas,idmhs|min:5|max:5',
            'txtnim' => 'required|unique:mahasiswas,nim|min:10|max:10',
            'txtnama' => 'required',
            'txtgender' => 'required',
            'txtalamat' => 'required',
    ...
    public function messages(): array
    {
        return [
            ...
            'txtid.min' => ':attribute Minimal 5 karakter',
            'txtid.max' => ':attribute Maksimal 5 karakter',
